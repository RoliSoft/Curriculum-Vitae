...
\section{Technical Skills}
	...
	\cvline{Main Focus}{Security research; Web, mobile and desktop development; Low-level programming within constraints and optimization; High-level programming, design patterns and abstract concepts}
...
\section{Notable Personal Projects}
	...
	\cvitem{Windows Subsystem for Linux Distribution Switcher}{\small{Achieved and maintained 1\textsuperscript{st} place on the Hack the Box OSCP-like CTF game.}}
	\cvitem{Host Scanner}{\small{Achieved and maintained 1\textsuperscript{st} place on the Hack the Box OSCP-like CTF game.}}
	\cvitem{RS TV Show Tracker}{\small{Achieved and maintained 1\textsuperscript{st} place on the Hack the Box OSCP-like CTF game.}}
