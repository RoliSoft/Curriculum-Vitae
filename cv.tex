...
\usepackage{sectsty}
\sectionfont{\raggedright\color{LightBlue}\sectionrule{0pt}{0pt}{-5pt}{0.4pt}}
...
\section{Education}
	...
	{\large\textbf{B.Sc. Computer Engineering}}\\
	\textit{Sapientia EMTE, Faculty of Technical and Human Sciences, Târgu-Mureș}\\
	Gave multiple presentations in various fields; attended the XVI. Scientific Student Conference with a project which won a special award; participated in a research group studying sentiment analysis as an extracurricular activity; doing thesis in the field of Information Security.\\
	\textit{September 2012 -- July 2016}

\section{Experience}
	{\large\textbf{BrightAlien Ltd}}\\
	\textit{DevOps Engineer and Full-Stack Developer}\\
	...
	{\large\textbf{Lynx Solutions}}\\
	\textit{Android Developer}\\
...
\section{Certifications}
	{\large\textbf{IPv6 Certified Sage}}, Hurricane Electric, \textit{March 2011}
	
\section{Publications}
	{\large\textbf{Sapiness Sentiment Analyser}}, Katalin Tünde Jánosi-Rancz, Zoltán Kátai and Roland Bogosi; \textit{Acta Universitatis Sapientiae, Informatica,} vol. 7, no. 2, pp. 186--199, 2015.

\section{Languages}
	{\large\textbf{English}}: Full professional proficiency\\
	{\large\textbf{Hungarian, Romanian}}: Native or bilingual proficiency

\newpage

\section{Technical Skills}
	\begin{itemize}
	\item	\label{softdev} \pdfbookmark[2]{Software Development}{softdev} \textbf{10 years} of experience in \textbf{.NET}/\textbf{C\#}.
		\begin{itemize}
	...
	\item	Additionally, strong self-taught knowledge in the following fields:
		...
		\item	\textbf{Networking}
			...
			\item	\textbf{Strong knowledge} of several popular \textbf{Layer-7 protocols}
			\end{itemize}
		\item	\label{pentest} \pdfbookmark[2]{Penetration Testing}{pentest} \textbf{Penetration Testing}
			\begin{itemize}
...
\section{Extracurricular School Projects}
	...
	\item	\label{arch} \pdfbookmark[2]{Assembly Compiler for Course-made CPU on FPGA}{arch} \textbf{Assembly Compiler for Course-made CPU on FPGA} (\textit{Computer Architecture})
		...
		\end{itemize}
	\item	\label{db2} \pdfbookmark[2]{Sentimental Analysis of Text on Social WebSites}{db2} \textbf{Sentimental Analysis of Text on Social WebSites} (\textit{Databases II})
		\begin{itemize}
