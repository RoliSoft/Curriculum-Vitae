...
\section{Technical Skills}
	\begin{itemize}
	\item	\label{webdev} \pdfbookmark[2]{Web Development}{webdev} \textbf{11 years} of experience in \textbf{HTML}, \textbf{CSS}, \textbf{JavaScript}, \textbf{PHP} and \textbf{MySQL}.
		\begin{itemize}
		...
		\end{itemize}
	\item	\label{softdev} \pdfbookmark[2]{Software Development}{softdev} \textbf{9 years} of experience in \textbf{.NET}/\textbf{C\#}.
		\begin{itemize}
		...
		\end{itemize}
	\item	\label{devops} \pdfbookmark[2]{System Administration/DevOps}{devops} \textbf{7 years} of experience in \textbf{Unix-like systems} (\textbf{Linux}, \textbf{BSD})
		\begin{itemize}
