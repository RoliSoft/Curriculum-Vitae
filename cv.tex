...
\section{Media Attention}
	...
	Part of my personal project endeavours and academic research, I've autonomously analysed various banking infrastructure and \textbf{found critical issues} in at least \textbf{two leading Romanian banks}, of the \textit{authentication and authorization bypass} level. I followed \textbf{responsible disclosure procedures}, notified the banks and the local CERT of these incidents. What followed was media attention in TV, radio, and online news, after \textbf{CERT-RO} published a congratulatory press release: \httplink[https://goo.gl/D3w8b3]{cert.ro/citeste/divulgarea-coordonat-a-vulnerabilit-ilor-component-esen-ial-a-securit-ii-cibernetice}
...
\section{Awards \& Honors}
	...
	\vspace{-2pt} {\small{Special sponsor prize for the "Sentiment Analysis of Social Networks" research.}}
...
\section{Technical Skills}
	...
	\cvline{Languages}{C\# \textit{(13 years)}, Java \textit{(12 years)}, C/C++ \textit{(11 years)}, Go, Python, PHP \textit{(15 years)}, JavaScript, SQL}
...
\section{Personal Development}
	...
	\begin{itemize}
	\item	\label{softdevcs} \pdfbookmark[2]{C\# Software Development}{softdevcs} \textbf{13 years} of experience in \textbf{.NET}/\textbf{C\#}.
		\begin{itemize}
	...
	\begin{itemize}
	\item	\label{softdevcpp} \pdfbookmark[2]{C++ Software Development}{softdevcpp} \textbf{11 years} of experience in \textbf{C}/\textbf{C++}.
		\begin{itemize}
	...
	\begin{itemize}
	\item	\label{webdev} \pdfbookmark[2]{Web Development}{webdev} \textbf{15 years} of experience in \textbf{HTML}, \textbf{CSS}, \textbf{JavaScript}, \textbf{PHP} and \textbf{MySQL}.
		\begin{itemize}
	...
	\begin{itemize}
	\item	\label{devops} \pdfbookmark[2]{System Administration/DevOps}{devops} \textbf{11 years} of experience in \textbf{Unix-like systems} (\textbf{Linux}, \textbf{BSD})
		\begin{itemize}
