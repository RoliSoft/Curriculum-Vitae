...
\section{Experience}
	...
	\cventry{July 2014--August 2014}{Android Developer Internship}{Lynx Solutions SRL}{Târgu-Mure\cb{s}}{}{Wrote full application specification document; developed the documented Android-based application with UI accommodating both smartphones and tablets alike; oversaw fellow interns through their journey of implementing the documented REST API.}
